...
// Created by Felipe Lira (https://github.com/phi-lira). 
// Modified by Chris Cunningham to add "Cloud Shadows" effect.

Shader "Universal Render Pipeline/Custom/Lit Cloud Shadows"
{
    Properties
    {
